...
function Actions.actions()
    ...
    return {
        ...
        move_window_l = Fnutils.partial(Actions.PaperWM.windows.moveWindowToScreen, Direction.LEFT),
        move_window_r = Fnutils.partial(Actions.PaperWM.windows.moveWindowToScreen, Direction.RIGHT),
        move_window_u = Fnutils.partial(Actions.PaperWM.windows.moveWindowToScreen, Direction.UP),
        move_window_d = Fnutils.partial(Actions.PaperWM.windows.moveWindowToScreen, Direction.DOWN),
